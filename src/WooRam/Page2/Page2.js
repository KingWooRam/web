...
import imgsrc1 from './styles/2.png';
import imgsrc2 from './styles/1.png';
...
const Page2 = () => {
    ...
    return (
        <div className="page2-container">
            ...
            <img src={imgsrc2} alt="Activity Guide Icon" />
            <p className="description">다음은 세계보건기구에서 지정한 신체활동 기준입니다. 소리 내어 읽어보세요.</p>
            <div className="activity-guide">
                <h3 className="subsection-title">건강증진을 위해 65세 이상 노인들은</h3>
            ...
            <img src={imgsrc1} alt="Guideline Icon" />
            <br></br>
